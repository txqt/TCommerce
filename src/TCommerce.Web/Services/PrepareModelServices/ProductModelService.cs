...
namespace TCommerce.Web.PrepareModelServices
{
    ...
    public class ProductModelService : IProductModelService
    {
        ...
        public ProductModelService(IMapper mapper, IProductService productService, IUrlRecordService urlRecordService, ICategoryService categoryService, IPictureService pictureService)
        {
            _mapper = mapper;
